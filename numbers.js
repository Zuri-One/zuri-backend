...
const processUsers = async () => {
  ...
  const usersToProcess = [
    ...
    // 6. Atim Esther Ruth - Create New Doctor (Ugandan)
{
  action: "create",
  userData: {
    surname: "Atim",
    otherNames: "Esther Ruth",
    email: "eruth@zuri.health",
    ...
    employeeId: "ZH-AER-2025",
    licenseNumber: "UMD-" + Math.floor(10000 + Math.random() * 90000), // Uganda Medical License
    specialization: ["General Medicine"],
    qualification: ["MD"],
    telephone1: "+256704957122", // Already has country code
    gender: "FEMALE",
    dateOfBirth: generateRandomDOB(),
    town: "Kampala",
    areaOfResidence: "Kampala",
    idType: "NATIONAL_ID",
    idNumber: generateRandomID("Uganda"), // 9-digit ID for Uganda
    nationality: "Ugandan",
